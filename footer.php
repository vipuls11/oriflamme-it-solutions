        ...
        <div class="container mx-auto  px-8 grid lg:grid-cols-3 py-5 lg:gap-5 place-content-center w-full">
            <div class="flex items-center text-white gap-5 pb-5 lg:pb-0">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold"><a href="tel:022 49716152"> 022 49716152</a><span>/</span><a
                            href="tel:022 4971292"> 022 4971292</a></p>
                </div>
            </div>
            ...
            <div class="flex items-center lg:justify-start text-white">
                <div>
                    ...
                    <p class="text-xl  font-bold mr-4"><a href="mailto: support@oriflammeitsolutions.com">
                            support@oriflammeitsolutions.com</a></p>
                </div>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-10 h-10">
        ...
        <footer class=" ">
            <div class="container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8  p-5  text-lg  ">
                <div class="text-left">
                    ...
                    <p class="text-lg  my-10 text-white">We have 10+ years experience. Helping you overcome technology
                        challenges.</p>
                    <div class="text-white">
                        <a class="facebook mx-2 text-4xl font-semibold hover:text-blue-700 text-blue-600"><i
                                class="fa-brands fa-facebook-f"></i></a>
                        <a class="twitter mx-2 text-4xl font-semibold hover:text-blue-700 text-blue-500"><i
                                class="fa-brands fa-twitter"> </i></a>
                        <a class="linkedin mx-2 text-4xl font-semibold hover:text-blue-700 text-sky-700"><i
                                class="fa-brands fa-linkedin"></i></a>
                        <a class="pinterest mx-2 text-4xl font-semibold hover:text-blue-700 text-red-700"><i
                ...
                <div class="cursor-pointer">
                    ...
                    <div class="py-10">
                        <div class="text-lg  my-0 text-white">
                            <p><span>Address : </span>1st Floor, Unit No 18, Nand Ghanshyam Industrial Estate, Off
                                Mahakali Caves Rd, Andheri East, Maharashtra 400093</p>
                        </div>
                        <p class="text-lg  my-5 text-white"><span>Email :</span><a
                                href="mailto: pravin@oriflammeitsolutions.com"> pravin@oriflammeitsolutions.com</a></p>
                        <p class="text-lg text-white"><span>Phone :</span><a href="tel:+91-9930425384">
                                +91-9930425384</a><span>/</span><a href="tel:9930646412"> 9930646412</a></p>
                    </div>
                </div>
                ...
                <div class="cursor-pointer">
                    ...
                    <div class="py-10">
                        <p class="text-lg  text-white">Subscribe to our newsletter to receive updates on the latest
                            news!</p>
                        <div class="my-10">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" id="default-search" name="email"
                                        class="block w-80 mx-auto p-2 pl-5 text-lg  text-gray-700 border border-gray-300  bg-gray-50  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                                        placeholder="Subscribe with us">
                                    <button type="submit"
                                        class="text-gray-800 absolute lg:right-10  left-[300px] sm:right-12 -bottom-1 text-3xl px-4 py-2 "><i
                                            class="fa-solid fa-paper-plane"></i></button>

                                </div>
                                <div class="text-center">
                                    <span
                                        class="py-2  text-red-600 text-sm error"><?php echo "\n" . $emailErr; ?></span>
                                </div>
                            </form>
                            <div class="">
                                <?php
            ...
            <div>
                <div class="text-center py-5 border-t border-t-white">
                    <p class="text-lg text-white">© 2023 Oriflamme It Solution Powered by <span
                            class="text-red-600">Oriflamme</span></p>
                    <div class="text-right bg-red-200">
                        <button id="scroll"
                            class="border border-sky-600 p-4 bg-sky-800 fixed bottom-4 right-4 mt-2 text-4xl text-red-700 rotate-90">&#10096;</button>
                    </div>
                </div>
            </div>
            <div class="lg:hidden block">
                <div
                    class="fixed bottom-0 class grid grid-cols-2 w-full bg-sky-950 text-center opacity-50 hover:opacity-100">
                    <div class="border p-2 ">
                        <a href="tel:+91-9930425384"><button class="text-white font-semibold text-sm"><span
                                    class="text-red-650"><i class="fa-solid fa-phone"></i></span> <br> +91
                                9930425384</button></a>
                    </div>
                    <div class="border p-2 ">
                        <a href="mailto: pravin@oriflammeitsolutions.com"><button
                                class="text-white text-sm font-semibold"><span class="text-red-650"><i
                                        class="fa-solid fa-envelope"></i></span> <br>
