...
<div class="bg-sky-950">
        ...
        <div class="cursor-pointer">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">   
                ...
                <div class="relative">
                    ...
                    <input type="email" id="default-search" name="email" class="block w-80 mx-auto p-2 pl-5 text-lg  text-gray-700 border border-gray-300  bg-gray-50  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Subscribe with us" >
    ...
    <div class="fixed bottom-0 class grid grid-cols-2 w-full bg-sky-950 text-center opacity-50 hover:opacity-100">
    <div class="border p-2 ">
         <a href="tel:+91-9930425384"><button class="text-white font-semibold text-sm"><span class="text-red-650"><i class="fa-solid fa-phone"></i></span> <br> +91 9930425384</button></a>
    </div>
    <div class="border p-2 ">
    <a href="mailto: pravin@oriflammeitsolutions.com"><button class="text-white text-sm font-semibold"><span class="text-red-650"><i class="fa-solid fa-envelope"></i></span> <br> pravin@oriflammeitsolutions.com</button></a>
    </div>
</div>
</div>
    </footer>
    ...
    <div class="popup" id="mymodal">
        <div class="popup-content">
            <div class="grid lg:grid-cols-2 gap-2">
                ...
                <div class="">
                    <span id="" class="close text-red-600" ><h1  class="font-extrabold" >X</h1></span>
                    
                   <div class="my-3 lg:bg-[url('')] bg-[url('image/section-itsupport.png')] bg-center bg-contain bg-no-repeat border-2 border-sky-950 rounded-xl p-3" style="box-shadow: rgb(38, 57, 77) 0px 20px 30px -10px;">
                    <h2 class="text-xl font-extrabold mb-5 text-sky-950">Subscribe to our free E-mailer to stay on top of the industry news and insights.</h2>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                    <div class="text-center">
                <span class="py-2  text-red-600 text-sm error"><?php echo "\n".$emailErr; ?></span>
                </div>
                        <input type="email" name="email" id="" placeholder="Enter your E-mail" class="py-2 px-2 border-2 border-black  w-full opacity-75 rounded-lg">

                            <div class="flex items-start my-3 gap-2 text-justify">
                                <input type="checkbox"  class="mt-0.5">
                               <div>
                                <p class="text-xs">I agree to receive your newsletters and to terms and conditions.</p>
                                <p class="text-xs">You may unsubscribe at any time using the link newsletter.</p> 
                               </div>    
                            </div>
                            <button type="submit"  class="button px-4 rounded-lg my-3 py-2 bg-red-600 border-2 border-sky-950 text-white font-semibold">Subscribe</button>
                    </form>
                   </div>
                </div>
            </div>
