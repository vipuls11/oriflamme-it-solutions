...
<?php include("header.php") ?>
 ...
 <div class="container mx-auto w-full relative opacity-80">
        ...
        <div class="absolute top-80 left-5 lg:block hidden">
            <h1 class="text-5xl font-semibold text-white">Pravin Rai</h1>
            <div class="flex gap-4 px-4 items-center my-10 opacity-95 bg-slate-50 py-4 text-center text-xl font-semibold text-center justify-center">
                ...
                <h2><a href="pravin.php">Pravin Rai</a></h2>
            </div>
        </div>
        <div class="absolute top-28 left-5  lg:hidden block">
            <h1 class="text-2xl font-semibold text-white">Pravin Rai</h1>
    ...
    <div class="flex container mx-auto my-20">
        ...
        <div class="w-2/3">
        <div class="mx-8">
        <h1 class="uppercase text-red-800 text-md font-semibold">Founder</h3>
        <h1 class="text-4xl font-extrabold mt-5 text-sky-950 ">Pravin Rai</h1>
