...
<?php include("header.php") ?>
 ...
 <div class="container mx-auto w-full relative opacity-80">
        ...
        <div class="absolute top-80 left-5 lg:block hidden">
            <h1 class="text-5xl font-semibold text-white">Career</h1>
        ...
        <div class="absolute top-28 left-5  lg:hidden block">
            <h1 class="text-2xl font-semibold text-white">Career</h1>
  ...
  transform: rotateY(30deg); box-shadow: 10px 10px 14px #000000;"  ></div>
    ...
    <div class="bg-gray-300">
        <div class="grid grid-cols-2 py-20 items-center w-[90%] m-auto">
            <div>
            <h3 class="text-4xl font-extrabold">Talk To Our Experts <span class="text-sky-950">Today!</span></h3>
            <p class="mt-3 ">We’re here to help you with the right information and solution you need!</p>
            </div>
            <div class=" text-center">
                <button class="bg-sky-950 text-white font-extrabold border border-sky-800 px-6 py-2 rounded-lg" style="box-shadow: 6px 6px 10px #000000;">Get In Touch</button>
            </div>
        </div>
        </div>
     <!-- ...................Experts talk...................... -->
